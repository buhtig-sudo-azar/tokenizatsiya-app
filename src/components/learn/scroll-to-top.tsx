 ...
 * Цвет — фиолетовый (соответствует теме токенизации).
 */
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-purple-400/50",
        visible
    ...
    >
      <span
        aria-hidden
        className="absolute inset-0 rounded-full bg-purple-500/30 animate-brain-pulse-ring"
      />
      <span
        aria-hidden
        className="absolute inset-1 rounded-full bg-purple-500/20 animate-brain-pulse-ring-delayed"
      />
      <span
        aria-hidden
        className="absolute inset-2 rounded-full bg-gradient-to-br from-purple-500 to-fuchsia-600 shadow-lg shadow-purple-500/40 animate-brain-pulse-core"
      />
